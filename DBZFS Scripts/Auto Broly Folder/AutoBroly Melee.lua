...
Settings = {
    ...
    RejoinTime = 60;  -- rejoins in broly if this time is exceeded
    GrabChecker = 30;  -- time it takes for broly to be last form, rejoins you if hes not by then
    ...
    waittime = .5;  -- The time waited before the script loads
}
