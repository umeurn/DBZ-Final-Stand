...
Move5 = "Deadly Dance"
Move6 = "Strong Kick"
Move7 = "Neo Wolf Fang Fist"

Settings = {
    Earth = true; -- True to auto on earth, false to auto on queue (Recommended if you bug in queue)
    ...
    RejoinTime = 20;  -- rejoins in broly if this time is exceeded
    ...
    waittime = .4;  -- The time waited before the script loads
}
...
local Credits =
    ...
    function()
        if Settings.Promote == true then
            while wait(2) do
                local A_1 = "Selling INF Stats Very Fast Dm NexusCloudz0001 via Discoard for Info"
                local A_2 = "All"
